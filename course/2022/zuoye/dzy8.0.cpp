...
{ /*在对列中寻找可处理元素，对其进行处理，
 ...
 更新逗留时间(已完成) */
  ...
  { // search如果没有返回0，有符合的返回要处理的人在sq的第几个
    ...
    totalTime += (back(eq)->endTime - p->beginTime); //更新逗留时间
