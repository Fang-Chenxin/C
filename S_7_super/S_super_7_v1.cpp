...
int main(void)
{
    ...
    assigment(&s_target, &v_target, &a_max, &j_max);        //给需要输入的变量赋值
    ...
    //}
    printf("\n");
    for (double xx = 0.0; xx < s_target; xx+=0.02)
    {
...
void assigment(double* s_target, double* v_target, double* a_max, double* j_max)    //给需要输入的变量赋值
{
    /*可以根据需要修改*/
    //printf("v_start:");
    //scanf("%f", &v_start);
...
{
    double w = PI / t[0];       //角频率
    //double w = PI / t[2];    //减加速阶段角频率
    //double w = PI / t[4];    //加减速阶段角频率
    //double w = PI / t[6];    //减减速阶段角频率
...
{
    double w = PI / t[0];       //角频率
    //double w2 = PI / t[2];    //减加速阶段角频率
    //double w4 = PI / t[4];    //加减速阶段角频率
    //double w6 = PI / t[6];    //减减速阶段角频率
